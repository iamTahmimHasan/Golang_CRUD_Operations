...
func updateMovie(w http.ResponseWriter, r *http.Request) {
	// set json contant type
	w.Header().Set("Content-Type", "application/json")
	// params
	params := mux.Vars(r)
	//loop over the movies
	//delete the movies range
	//delete the movie i.d that youi've sent
...
func main() {
	...
	movies = append(movies, Movie{ID: "2", Isbn: "438229", Title: "Movie Two", Director: &Director{Firstname: "Steve", Lastname: "Smith"}})
